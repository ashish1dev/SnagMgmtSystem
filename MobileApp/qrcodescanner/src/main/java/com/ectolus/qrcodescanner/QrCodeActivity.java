package com.ectolus.qrcodescanner;
...
import com.ectolus.qrcodescanner.camera.CameraManager;
import com.ectolus.qrcodescanner.decode.CaptureActivityHandler;
import com.ectolus.qrcodescanner.decode.DecodeImageCallback;
import com.ectolus.qrcodescanner.decode.DecodeImageThread;
import com.ectolus.qrcodescanner.decode.DecodeManager;
import com.ectolus.qrcodescanner.decode.InactivityTimer;
import com.ectolus.qrcodescanner.view.QrCodeFinderView;
...
public class QrCodeActivity extends Activity implements Callback, OnClickListener {
    ...
    private final String GOT_RESULT = "com.ectolus.qrcodescanner.got_qr_scan_relult";
    private final String ERROR_DECODING_IMAGE = "com.ectolus.qrcodescanner.error_decoding_image";
